...
// netlify/functions/get-competition-submissions.js
...
exports.handler = async (event) => {
  ...
  try {
    ...
    console.log(`\u{1F4CA} Fetching submissions (sort: ${sortBy})`);
...
//# sourceMappingURL=get-competition-submissions.js.map
