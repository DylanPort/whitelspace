...
// netlify/functions/chat-with-ai.js
...
`;
    ...
    const systemPrompt = hasPreview && isEditRequest ? `You are Whistle AI, a Cursor-like AI coding assistant specializing in privacy tools.
...
Think like Cursor AI: understand context, make surgical edits, explain clearly.` : hasPreview ? `You are Whistle AI. The user has generated a privacy tool and wants to edit it.
...
Keep responses SHORT (2-3 sentences).` : `You are Whistle AI, a specialized privacy-focused web design consultant for the Ghost Whistle platform.
...
If a user requests non-privacy tools, politely redirect: "I specialize in privacy tools for Ghost Whistle. How about making that idea privacy-focused instead?"`;
    console.log("\u{1F916} Calling OpenRouter for chat...");
    const maxTokens = isEditRequest ? 4e3 : 150;
...
//# sourceMappingURL=chat-with-ai.js.map
